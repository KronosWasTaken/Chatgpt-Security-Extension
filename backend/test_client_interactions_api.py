...
async def test_client_interactions_api():
    ...
    async with httpx.AsyncClient() as client:
        ...
        print("\n1⃣ Testing GET /clients/{client_id}/interactions")
        try:
        ...
        print(f"\n2⃣ Testing GET /clients/{TEST_CLIENT_ID}/applications/{TEST_APP_ID}/interactions")
        try:
        ...
        print(f"\n3⃣ Testing POST /clients/{TEST_CLIENT_ID}/interactions/increment")
        try:
            payload = {
                "app_id": TEST_APP_ID,
                "interaction_count": 5,
        ...
        print(f"\n4⃣ Testing GET /clients/{TEST_CLIENT_ID}/interactions (after increment)")
        try:
            response = await client.get(f"{BASE_URL}/clients/{TEST_CLIENT_ID}/interactions")
            print(f"   Status: {response.status_code}")
            if response.status_code == 200:

...
export default function Header({ onLogout, userEmail }: HeaderProps) {
  return (
    <header className="flex items-center justify-between p-8 pb-12">
      <div className="flex items-center space-x-6">
        <div className="flex items-center justify-center w-16 h-16 shadow-xl bg-gradient-to-br from-purple-500 to-blue-600 rounded-2xl">
          <svg 
      ...
      <div className="flex items-center space-x-4">
        {onLogout && (
          <button 
            onClick={onLogout}
            className="flex items-center space-x-2 px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-lg transition-colors text-sm text-slate-300 hover:text-white"
        ...
        <button className="p-3 transition-colors bg-slate-700 rounded-xl hover:bg-slate-600 group">
